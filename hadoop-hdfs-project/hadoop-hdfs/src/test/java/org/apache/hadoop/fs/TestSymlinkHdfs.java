...
abstract public class TestSymlinkHdfs extends SymlinkBaseTest {
  ...
  @Ignore //TODO have a max_name_lenght and make to test: testCreateLinkMaxNameLink and testCreateLinkMaxPathLink
  //The second one need to build the path with names smaller than max_name_lenght
  @Test(timeout=10000)
  ...
  public void testQuota() throws IOException, InterruptedException {
    ...
    Thread.sleep(2000); //in Hops the quota are computed assynchronously 
    try {
