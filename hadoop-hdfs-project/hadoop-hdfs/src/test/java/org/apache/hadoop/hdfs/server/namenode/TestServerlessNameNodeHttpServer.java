...
public class TestServerlessNameNodeHttpServer {
  private static final String BASEDIR = System.getProperty("test.build.dir",
      "target/test-dir") + "/" + TestServerlessNameNodeHttpServer.class.getSimpleName();
  ...
  public TestServerlessNameNodeHttpServer(Policy policy) {
    super();
    this.policy = policy;
  }
  ...
  public static void setUp() throws Exception {
    ...
    sslConfDir = KeyStoreTestUtil.getClasspathDir(TestServerlessNameNodeHttpServer.class);
