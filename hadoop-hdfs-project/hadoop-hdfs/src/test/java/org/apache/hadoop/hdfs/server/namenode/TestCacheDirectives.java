...
public class TestCacheDirectives {
    ...
    GenericTestUtils.waitFor(new Supplier<Boolean>() {
      ...
      public Boolean get() {
        try {
          ...
          Set<CachedBlock> cachedBlocks = cacheManager.
              getCachedBlocks(namesystem.getBlockManager().getDatanodeManager());
  ...
  //this test can not run into a race condition in which the cache report happen before the heartbeat
