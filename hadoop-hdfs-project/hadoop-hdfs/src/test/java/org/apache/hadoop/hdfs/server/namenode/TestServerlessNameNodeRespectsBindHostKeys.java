 ...
 */
public class TestServerlessNameNodeRespectsBindHostKeys {
  public static final Log LOG = LogFactory.getLog(TestServerlessNameNodeRespectsBindHostKeys.class);
  ...
  private static final String BASEDIR = System.getProperty("test.build.dir",
      "target/test-dir") + "/" + TestServerlessNameNodeRespectsBindHostKeys.class.getSimpleName();
  ...
  private static void setupSsl() throws Exception {
    ...
    final String sslConfDir = KeyStoreTestUtil.getClasspathDir(TestServerlessNameNodeRespectsBindHostKeys.class);
