...
public interface WriteAcknowledgementDataAccess<T> extends EntityDataAccess {
     ...
     */
    List<T> getPendingAcks(long nameNodeId) throws StorageException;
     ...
     * @throws StorageException
     */
    List<T> getPendingAcks(long nameNodeId, long minTime) throws StorageException;
     ...
     */
    void acknowledge(List<T> writeAcknowledgements) throws StorageException;
